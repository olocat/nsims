		...
		<div class="main-panel">
			<div class="content-wrapper">
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item">
								<a href="${pageContext.request.contextPath}/nurse">护士信息</a>
							</li>
							<li class="breadcrumb-item active" aria-current="page">添加护士信息</li>
						</ol>
					</nav>
				</div>
				...
				<div class="col-12 grid-margin">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">添加护士信息</h4>
							<form class="form-sample" action="${pageContext.request.contextPath}/nurse/doAdd" method="post">
